/*
Version hints implemented by the integrated backend:
  generic / generic_sparse_direct : sparse direct correctness path, no GAO precompute.
  v4 / v4_sparse_precompute      : custom sparse GAO precompute path, no cuBLAS.
